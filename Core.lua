...
function RM.CheckAndMarkPartyMembersByRole()
    ...
    for i = 1, GetNumGroupMembers() - 1 do
        ...
        if role == "HEALER" and RMS.healerEnabled and not healerMarked and not currentMarker then
            SetMarkerOnUnit(unit, RMS.healerMarker)  -- Healer marker
            healerMarked = true
        elseif role == "TANK" and RMS.tankEnabled and not tankMarked and not currentMarker then
